...
PAYLOAD='{"click_id":"l-1","correlation_id":"l","vertical_id":"credit_cards","device":"mobile","geo":"GB","hour_of_day":10,"product_type":"cashback","card_product_id":"card-x","query_intent":"compare","affinity_score":0.7,"ad_creative_id":"a","prior_applicant":false,"income_band_bucket":"mid","auction_pressure":0.5,"rpc_14d":1.0,"rpc_60d":1.0,"landing_path":"/","visits_prev_30d":0}'
